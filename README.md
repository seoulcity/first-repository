...
깃과 마크다운을 실습하면서 주요한 개념들을 다시 돌아볼 수 있었고, 간단한 도구이지만 실제로 많은 사람들의 삶을 바꾸는 소프트웨어와 엔지니어링의 기반ㅇ ㅣ된다는 점을 새삼 다시 느낄 수 있었다.

마크 저커버그가 인공지능에 대해서 언급한 7년 전의 기사와 GPT가 등장해서 사람들에게 새로운 기대를 불러일으키고 있는 최근의 모습을 비교하면서, 인공지능은 어떤 점에서는 더디게 전진하지만 또 어떤 점에서는 매우 빠르게 사람들의 삶에 침투하고 있다고 느낀다.

기술이 사람들에게 원하는 것을 제공할 수 있다면, 중요한 것은 사람들이 무엇을 원하느냐에 관한 문제일 것이다. 기술 그 자체에 대해서가 아니라, 기술을 통해서 무엇을 구현하고자 하는지, 나는 왜 아이펠을 신청하고 공부를 시작했는지에 대해서 돌아보게 되었다. 
